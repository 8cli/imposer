...
async function handler(): Promise<Data> {
    const feed = await parser.parseURL('https://techxplore.com/rss-feed/');
    return {
        title: feed.title ?? 'TechXplore',
        link: feed.link ?? 'https://techxplore.com/rss-feed/',
