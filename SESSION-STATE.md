...
> 公开仓库：**https://github.com/8cli/imposer**（MIT，master @ 96fdd47）+ **8cli/linotype**（main @ 31ba131）
...
GitHub：
  ...
  8cli/imposer   @ 96fdd47  master （拼版工，供给方，FreshRSS 查询器 + 66 源 53 走 RSSHub；第十一轮归属增强 + 主栏补白 + 血泪 #56-60）
