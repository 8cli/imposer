...
MAX_MAIN_WORDS = {1: 340, 2: 280, 3: 280, 4: 280}  # P1 血泪 #49/#51: 单栏视觉高 = contentH − 版头 = 529.3pt；真实正文 3.0pt/词 → 两栏 353 词填满。cap 355 实测微超 1.2%（352 词 → 下边距只剩 10mm，内容延伸到 287mm > 版心底 281mm）；cap 340 → 版头 213 + 单栏 510 = 723pt ≈ 97.4%，留 2.6% 余量防溢出
