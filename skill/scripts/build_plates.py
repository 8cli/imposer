...
MAX_MAIN_WORDS = {1: 355, 2: 280, 3: 280, 4: 280}  # P1 血泪 #49: 单栏视觉高 = contentH − 版头 = 529.3pt；真实正文 3.0pt/词 → 单栏 176 词、两栏 353 词。cap 355 让 main 栏两栏填满（版头 213 + 单栏 529 = 742.6 = contentH）
